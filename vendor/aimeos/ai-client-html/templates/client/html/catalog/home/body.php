		...
		<div class="home-gallery <?= $enc->attr( $this->homeTree->getCode() ) ?> slider-container">
			...
			<?php foreach( $this->homeTree->getChildren() as $child ) : ?>
				<?php if( !( $mediaItems = $child->getRefItems( 'media', 'stage', 'default' ) )->isEmpty() ) : ?>
					...
					<!-- my page -->
					<div class="home-item cat-image ">
							<div class="home-stage catalog-stage-image">
								<a class="stage-item row" href="">
									<img class="stage-image" loading="true"
										src="https://wallpapercave.com/wp/wp12606246.jpg"
										srcset=""
										alt=""
									>
								</a>
						...
						<div class="home-item cat-image ">
							<div class="home-stage catalog-stage-image">
								<a class="stage-item row" href="">
									<img class="stage-image" loading="true"
										src="https://wallpapercave.com/wp/wp9519247.jpg"
										srcset=""
										alt=""
									>
								</a>
						...
						<div class="home-item cat-image ">
							<div class="home-stage catalog-stage-image">
								<a class="stage-item row" href="">
									<img class="stage-image" loading="true"
										src="https://wallpapercave.com/wp/wp6758418.jpg"
										srcset=""
										alt=""
									>
								</a>
